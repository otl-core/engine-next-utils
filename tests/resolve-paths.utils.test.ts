  ...
  it("returns data on success", async () => {
    const mockResponse = {
      paths: [
        ...
        { path: "/blog", content_type: "collection", locale: "en" },
      ],
      pagination: {
        page: 1,
        limit: 1000,
      ...
      .mockResolvedValueOnce({
        ...
        data: {
          paths: [
            ...
            { path: "/page4", content_type: "entry", locale: "en" },
          ],
          pagination: {
            page: 2,
            limit: 2,
    ...
    mockWebsiteService.fetchAllPaths.mockResolvedValue({
      ...
      data: {
        paths: [
          ...
          { path: "/blog/post", content_type: "entry", locale: "en" },
        ],
        pagination: {
          page: 1,
          limit: 1000,
